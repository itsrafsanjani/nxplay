    ...
    <section class="section section--details section--bg" data-bg="{{ asset('img/section/details.jpg') }}">
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-5 col-lg-6 col-xl-5">
                                <div class="card__cover">
                                    <img src="https://imdb-api.com/posters/w300/{{ $video->poster }}" alt="">
                                    ...
                                    <ul class="card__meta">
                                        ...
                                        <li>
                                            <div class="comments__rate" style="position: relative; left: 0; top: 0; margin-top: 5px; border: 2px solid rgba(26,25,31,.7); border-radius: 3px; padding: 5px 30px; background: rgba(26,25,31,.7);">
                                                <form action="{{ route('frontend.video_like_or_dislike') }}" method="post" id="likeDislikeForm" style="display: inline-flex">
                                                    @csrf
                ...
                <!-- player -->
                <div class="col-12 col-lg-6">
                    <video controls crossorigin playsinline poster="https://imdb-api.com/posters/w300/{{ $video->poster }}" id="player">
                        <!-- Video files -->
